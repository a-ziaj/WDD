...
// Define the path to the FASTA file based on the job ID
$FASTA_FILE = "/tmp/{$row['protein_family']}_{$row['taxonomic_group']}_sequences.fasta";
//$FASTA_FILE = str_replace(' ', '_', $FASTA_FILE);
echo "FASTA file path: {$FASTA_FILE}<br>";
...
// Count the number of sequences in the FASTA file (sequences are typically indicated by '>' in the header)
...
<!-- Form to move to conservation.php for further analysis -->
