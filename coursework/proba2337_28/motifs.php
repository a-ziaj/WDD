...
<head>
    ...
    <style>
        ...
        .download-btn { display: inline-block; background: #3498db; color: white; padding: 10px 20px; text-decoration: none; border-radius: 5px; margin-top: 20px; transition: all 0.3s; border: none; cursor: pointer; font-size: 1em; }
